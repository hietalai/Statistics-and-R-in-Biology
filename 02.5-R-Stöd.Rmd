...
## Ladda in datamaterial {#readData}
...
![Exempel på en fil öppnad i Notepad](images/Chapter 3/notepad.png)
...
## Arbetsmappar
Att importera datamaterial är endast ett sätt där vi interagerar med datorns hårddisk. Vi kan ibland vilja spara ner objekt eller visualiseringar mer permanent och då kommer vi återigen behöva ange en <span class="terminology">sökväg</span> till någonstans på datorn. För att underlätta denna process kan vi använda oss utav <span class="terminology">arbetsmappar</span> (eng. working directory).
...
![Exempel på en fråga och svar med ChatGPT](images/Chapter 3/chatgpt.png)
